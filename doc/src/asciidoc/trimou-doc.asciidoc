...
Phone numbers: {{#json.phoneNumbers}}{{number}}{{#iterHasNext}}, {{/iterHasNext}}{{/json.phoneNumbers}}
Type of the first phone number: {{json.phoneNumbers.0.type}}
Type of the second phone number: {{json.phoneNumbers.1.type}}
----
...
String output = mustache.render(ImmutableMap.<String, Object> of("json", jsonElement));
----
