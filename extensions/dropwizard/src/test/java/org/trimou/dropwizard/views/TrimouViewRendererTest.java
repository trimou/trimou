...
public class TrimouViewRendererTest extends JerseyTest {
    ...
    public void testSimpleView() throws Exception {
        ...
        assertEquals("Hello Martin!", response);
    }
    ...
    public void testLocallizedView() throws Exception {
        assertEquals("Ahoj!", client().resource(getBaseURI() + "test/localized").acceptLanguage(new Locale("cs")).get(String.class).trim());
        assertEquals("Hallo!", client().resource(getBaseURI() + "test/localized").acceptLanguage(Locale.GERMANY).get(String.class).trim());
        assertEquals("Salut!", client().resource(getBaseURI() + "test/localized").acceptLanguage(Locale.FRANCE).get(String.class).trim());
    }
    ...
    public void testComplexView() throws Exception {
        ...
        assertEquals("Hello Martin again!", response);
    }
